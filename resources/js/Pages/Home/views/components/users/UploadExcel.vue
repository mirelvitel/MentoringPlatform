...
function uploadExcel(event) {
    ...
    axios.post('/users/upload-excel', formData, {
        headers: {
...
<!--            <button @click="uploadExcel" class="bg-primary text-white p-2 rounded-lg mt-2">Upload</button>-->
        </div>
...
<!--                            {{ formatDate(user.created_at) }}-->
                        ...
                        <td class="p-4">
                            <button @click="deleteUser(user.id)" class="text-white bg-red-400 px-2 rounded font-semibold hover:bg-red-500 transition-all">
                                Delete
                            </button>
                        </td>
                    </tr>
